...
```
{
    "_index" : "github_contributors_org_repo",   //index名称 (index name)
    "_id" : "69aa8dc5589d6306de726ac0fe4cdc2dc1bf24c6",  //id 
    "_score" : 1.0,
    "_source" : {
      "uuid" : "69aa8dc5589d6306de726ac0fe4cdc2dc1bf24c6",   //id 
      "id_git_author_name_list" : [     //Git作者名称 (Git author name)
        "Travis Beatty"
      ],    
      "id_git_author_email_list" : [   //Git 作者邮箱 (Git author email)
        "travisby@gmail.com"
      ],  
      "id_platform_login_name_list" : [     // Github平台/Gitee平台的登录名称 (Login name for Github/Gitee platforms)
        "travisby"
      ],  
      "id_platform_author_name_list" : [    // Github平台/Gitee平台的作者名称 (Author name for Github/Gitee platforms)
        "Travis Beatty"
      ],   
      "id_platform_author_email_list" : [    // Github平台/Gitee平台的作者邮箱 (Author email for Github/Gitee platforms)
        "travisby@gmail.com"         
      ],  
      "id_identity_list" : [        
        "travisby",
        "travisbeatty"
      ],  //贡献者身份信息:对贡献者邮箱前缀和贡献者名称去除特殊符号后, 并统一小写后得到  
          //(Contributor's identity information: Remove special symbols from the contributor's email prefix and contributor's name, and unify them in lowercase.)
      "first_issue_creation_date" : "2014-06-11T12:21:55.014834+00:00",     //首次Issue创建时间 (First issue creation Time)
      "first_pr_creation_date" : "2014-06-11T12:21:55.014834+00:00",        //首次PR创建时间 (First pull request creation Time)
      "first_issue_comments_date" : "2014-06-11T12:21:55.014834+00:00",     //首次Issue评论时间 (First issue comment Time)
      "first_pr_review_date" : "2014-06-11T12:21:55.014834+00:00",          //首次PR评论时间 (First pull request comment Time)
      "first_code_commit_date" : "2014-06-11T08:21:45.083475+00:00",        //首次Code提交时间 (First code commit Time)
      "first_fork_date" : "2014-06-11T12:16:06.082526+00:00",   //首次fork时间 (First fork Time)
      "first_star_date" : "2014-06-11T12:16:06.082526+00:00",   //首次star时间 (First star Time)
      "first_watch_date" : "2014-06-11T12:16:06.082526+00:00",  //首次watch时间 (First watch Time)
      "issue_creation_date_list" : [                //Issue创建时间列表 (Issue creation time list)
        "2014-06-11T12:16:06.082526+00:00",
        "2014-06-11T12:16:06.082526+00:00"
      ],
      "pr_creation_date_list" : [                   //PR创建时间列表 (Pull Request time list)
        "2014-06-11T12:21:55.014834+00:00"
      ],
      "issue_comments_date_list" : [                //Issue评论时间列表 (Issue comment time list)
        "2014-06-11T12:16:06.082526+00:00",
        "2014-06-11T12:16:06.082526+00:00"
      ],             
      "pr_review_date_list" : [                     //PR评论时间列表 (Pull Request comment list)
        "2014-06-11T12:16:06.082526+00:00",
        "2014-06-11T12:16:06.082526+00:00"
      ],
      "code_commit_date_list" : [                   //Code提交时间列表 (Code commit time list)
        "2014-06-11T08:21:45.083475+00:00"
      ],
      "fork_date_list" : [                          //fork时间列表 (Fork time list)
        "2014-06-11T12:16:06.082526+00:00"
      ],
      "star_date_list" : [                          //star时间列表 (Star time list)
        "2014-06-11T12:16:06.082526+00:00"
      ],
      "watch_date_list" : [                         //watch时间列表 (Watch time list)
        "2014-06-11T12:16:06.082526+00:00"
      ],
      "last_contributor_date" : "2014-06-11T12:21:55.014834+00:00",         //最后贡献时间 (Last contribution time)
      "org_change_date_list" : [                   //组织转变时间列表 (Organizational transformation timeline)
        {
          "domain" : "gmail.com",                               //邮箱后缀(Mailbox suffix)
          "org_name" : null,                                    //组织名 (Organization name)
          "first_date" : "2014-06-11T08:21:45.083475+00:00",    //组织贡献开始时间 (Start of organizational contribution)
          "last_date" : "2014-06-11T08:21:45.083475+00:00"      //组织贡献结束时间 (Organizational contribution end time)
        }
      ],
      "platform_type" : "github",       //平台类型:github, gitee (Platform type:github or gitee)
      "domain" : "gmail.com",           //最后参与贡献的邮箱后缀 (Last participating contributing mailbox suffix)
      "org_name" : null,                //最后参与贡献的组织名 (Last participating contributing Organization name)
      "community" : "kubernetes",       //社区名 (community name)
      "repo_name" : "https://github.com/kubernetes/kubernetes",     //仓库名 (repository name)
      "is_bot" : false,                 //是否机器人 (Robot or not)
      "update_at_date" : "2023-07-13T05:09:35.908271+00:00"         //文档数据更新时间 (Document data update time)
    }
} 
```
